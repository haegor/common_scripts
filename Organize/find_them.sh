...
# исключая саму директорию с исполнителями.
# По нахождении, в директориях затронутых исполнителей, он создаст субдирректорию,
# в которую сложит ссылки на все найденные файлы.
#
# Мановением руки (удалением -s) мягкие ссылки могут быть превращены в жёсткие,
# а заменой ln на mv файлы можно и вовсе переместить.
#
# 2023-2024 (c) haegor
#
